    ...
    def _real_extract(self, url, allowVP9=False, allowAgeGate=False):
        ...
        if 'yt-video-id' == video_id:
            ...
            while tries < 3:
                ...
                post_data = "{'videoId': '%s', 'params': 'Q0FFU0FnZ0M=', 'context': {'client': {'hl': '%s', 'clientVersion': '19.44.38', 'clientName': 'ANDROID', 'androidSdkVersion': 30, 'osName': 'Android', 'osVersion': '11',}}}" % (video_id, GetDefaultLang())
